            ...
            <div class="flex gap-5 max-md:flex-col">
                ...
                <div class="container mx-auto px-6 py-10">
                    ...
                    <form action="{{ route('add.cars') }}" method="POST" enctype="multipart/form-data" class="mt-8 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="flex flex-col">
                                <label for="plate_number" class="text-sm font-semibold text-gray-700">Plate
                                    Number</label>
                        ...
                        <div class="flex justify-start mt-8">
                            <button type="submit"
                                class="px-6 py-3 text-white bg-teal-700 rounded-lg hover:bg-teal-600 transition duration-300">Save
                                Vehicle</button>
                        </div>
                    </form>
                </div>
