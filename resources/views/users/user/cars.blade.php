<x-app-layout>
    <div x-data="{ carModal: false, paymentModal: false, selectedCategory: 'All', selectedCar: {}, carDetails: [], }" class="flex flex-col items-center bg-white">
                        ...
                        @foreach ($cars as $car)
                            <div x-show="selectedCategory === 'All' || selectedCategory === '{{ $car->category }}'"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <button @click.prevent="paymentModal = true; carDetails = @js($car);" class="mt-4 w-full bg-purple-600 text-white py-2 rounded-lg text-sm font-medium">
                                        Rent Car
                                    </button>
                                </div>
                            </div>
