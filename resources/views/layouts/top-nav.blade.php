<nav class="flex justify-between items-center px-8 py-4 w-full bg-white border-b border-slate-200 max-md:px-5">
    ...
    <div class="flex items-center">
        <img loading="lazy" src="{{ asset('images/Logo.png') }}" class="object-contain ml-10 w-32 max-md:w-24"
            alt="Company logo" />
    </div>
    ...
    <div class="flex gap-5 items-center mr-5">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col">
                ...
                <div class="text-md font-semibold text-neutral-950">{{ Auth::user()->firstname }}
